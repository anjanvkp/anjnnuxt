...
export default defineEventHandler(async (event) => {
  try {
    ...
    if (lasttmailsent > td) {
      throw createError({
        statusCode: 404,
        message: 'mail already sent today'
      });
    }
    ...
    console.log(data); // Log fetched documents
